...
from transformers_sy.models.maskformer.feature_extraction_maskformer import MaskFormerImageProcessor
from transformers_sy.models.maskformer.modeling_maskformer import (
    MaskFormerConfig,
