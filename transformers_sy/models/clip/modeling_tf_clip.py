...
class TFCLIPTextModel(TFCLIPPreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> from transformers_sy import AutoTokenizer, TFCLIPTextModel
...
class TFCLIPVisionModel(TFCLIPPreTrainedModel):
    ...
    def call(
        ...
        >>> import requests
        >>> from transformers_sy import AutoProcessor, TFCLIPVisionModel
...
class TFCLIPModel(TFCLIPPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from transformers_sy import AutoTokenizer, TFCLIPModel
    ...
    def get_image_features(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from transformers_sy import AutoProcessor, TFCLIPModel
