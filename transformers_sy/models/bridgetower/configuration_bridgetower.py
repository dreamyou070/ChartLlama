...
class BridgeTowerVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_sy import BridgeTowerVisionConfig
...
class BridgeTowerTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_sy import BridgeTowerTextConfig
...
class BridgeTowerConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_sy import BridgeTowerModel, BridgeTowerConfig
