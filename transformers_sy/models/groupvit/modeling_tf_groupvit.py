...
class TFGroupViTTextModel(TFGroupViTPreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> from transformers_sy import CLIPTokenizer, TFGroupViTTextModel
...
class TFGroupViTVisionModel(TFGroupViTPreTrainedModel):
    ...
    def call(
        ...
        >>> import requests
        >>> from transformers_sy import AutoProcessor, TFGroupViTVisionModel
...
class TFGroupViTModel(TFGroupViTPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from transformers_sy import CLIPTokenizer, TFGroupViTModel
    ...
    def get_image_features(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from transformers_sy import AutoProcessor, TFGroupViTModel
