...
class ChineseCLIPVisionModel(ChineseCLIPPreTrainedModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from transformers_sy import CLIPProcessor, ChineseCLIPVisionModel
...
class ChineseCLIPModel(ChineseCLIPPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from transformers_sy import AutoTokenizer, ChineseCLIPModel
    ...
    def get_image_features(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from transformers_sy import AutoProcessor, ChineseCLIPModel
