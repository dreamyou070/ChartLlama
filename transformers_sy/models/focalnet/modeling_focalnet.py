...
class FocalNetForMaskedImageModeling(FocalNetPreTrainedModel):
    ...
    def forward(
        ...
        Examples:
        ```python
        >>> from transformers_sy import AutoImageProcessor, FocalNetConfig, FocalNetForMaskedImageModeling
        >>> import torch
...
class FocalNetBackbone(FocalNetPreTrainedModel, BackboneMixin):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_sy import AutoImageProcessor, AutoBackbone
        >>> import torch
        >>> from PIL import Image
        >>> import requests
