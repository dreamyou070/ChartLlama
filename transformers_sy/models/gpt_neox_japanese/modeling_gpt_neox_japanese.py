...
class GPTNeoXJapaneseModel(GPTNeoXJapanesePreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_sy import AutoTokenizer, GPTNeoXJapaneseModel
        >>> import torch
...
class GPTNeoXJapaneseForCausalLM(GPTNeoXJapanesePreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_sy import AutoTokenizer, GPTNeoXJapaneseForCausalLM, GPTNeoXJapaneseConfig
        >>> import torch
