...
class BlipTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_sy import BlipTextConfig, BlipTextModel
...
class BlipVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_sy import BlipVisionConfig, BlipVisionModel
...
class BlipConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_sy import BlipConfig, BlipModel
