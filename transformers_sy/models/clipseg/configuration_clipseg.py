...
class CLIPSegTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_sy import CLIPSegTextConfig, CLIPSegTextModel
...
class CLIPSegVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_sy import CLIPSegVisionConfig, CLIPSegVisionModel
...
class CLIPSegConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_sy import CLIPSegConfig, CLIPSegModel
