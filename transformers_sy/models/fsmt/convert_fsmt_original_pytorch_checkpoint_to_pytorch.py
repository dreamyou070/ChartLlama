...
from transformers_sy import FSMTConfig, FSMTForConditionalGeneration
from transformers_sy.models.fsmt.tokenization_fsmt import VOCAB_FILES_NAMES
from transformers_sy.tokenization_utils_base import TOKENIZER_CONFIG_FILE
from transformers_sy.utils import WEIGHTS_NAME, logging
