...
class AlignTextModel(AlignPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_sy import AutoTokenizer, AlignTextModel
...
class AlignVisionModel(AlignPreTrainedModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from transformers_sy import AutoProcessor, AlignVisionModel
...
class AlignModel(AlignPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from transformers_sy import AutoTokenizer, AlignModel
    ...
    def get_image_features(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from transformers_sy import AutoProcessor, AlignModel
