...
from transformers_sy import AutoImageProcessor, VanConfig, VanForImageClassification
from transformers_sy.models.deprecated.van.modeling_van import VanLayerScaling
