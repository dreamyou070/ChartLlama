...
class ClapAudioModel(ClapPreTrainedModel):
    ...
    def forward(
        ...
        >>> from transformers_sy import AutoProcessor, ClapAudioModel
...
class ClapModel(ClapPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from transformers_sy import AutoTokenizer, ClapModel
    ...
    def get_audio_features(
        ...
        ```python
        >>> from transformers_sy import AutoFeatureExtractor, ClapModel
        >>> import torch
    ...
    def forward(
        ...
        ```python
        >>> from datasets import load_dataset
        >>> from transformers_sy import AutoProcessor, ClapModel
...
class ClapTextModelWithProjection(ClapPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_sy import AutoTokenizer, ClapTextModelWithProjection
...
class ClapAudioModelWithProjection(ClapPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from datasets import load_dataset
        >>> from transformers_sy import ClapAudioModelWithProjection, ClapProcessor
