...
class ClapTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_sy import ClapTextConfig, ClapTextModel
...
class ClapAudioConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_sy import ClapAudioConfig, ClapAudioModel
...
class ClapConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_sy import ClapConfig, ClapModel
    ...
    >>> from transformers_sy import ClapTextConfig, ClapAudioConfig
